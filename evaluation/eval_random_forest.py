...
def eval_saved_random_forest(
    *, model_path: str = "models/random_forest.pkl", verbose: bool = False
):
    """Evaluate the previously trained random forest model on the test set.
...
if __name__ == "__main__":
    ...
    eval_saved_random_forest(verbose=True)